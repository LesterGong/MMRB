...
MODEL = "gemini-2.5-flash-preview-04-17-nothinking"
MAX_RETRIES = 1
RETRY_DELAY_S = 1
CONCURRENT_LIMIT = 30
API_TIMEOUT_S = 1000
...
def main_cli() -> None:
    ...
    output_path_json = os.path.join(output_dir, "answer_gemini-2.5-flash-preview-04-17-nothinking_MMRB_data_mini10_only_answer.json")
