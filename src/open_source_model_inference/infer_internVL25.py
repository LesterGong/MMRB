...
answer_type = "cot"
model_size = "38"
model_path = f'./models/OpenGVLab/InternVL2_5-{model_size}B'
data_path = "./annotation_MMRB/MMRB_data.json"
output_path = f"./answer_full_internVL2_5-{model_size}B_{answer_type}_2.json"

device_map = split_model(f'InternVL2_5-{model_size}B')
...
existing_file_path = f"./answer_full_internVL2_5-{model_size}B_{answer_type}.json"
