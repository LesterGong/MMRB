...
def split_model(model_name):
    ...
    num_layers = {
        ...
        'InternVL3-14B': 48, 'InternVL3-38B': 64, 'InternVL3-78B': 80}[model_name]
...
answer_type = "cot"
model_size = "38"
model_path = f"./Skywork-R1V2-38B"
data_path = "./annotation_MMRB/MMRB_data_mini10.json"
output_path = f"./answer_mini10_R1V2-38B_{answer_type}_2.json"


device_map = split_model(f'InternVL3-38B')
...
existing_file_path = f"./answer_mini10_R1V2-38B_cot.json"
